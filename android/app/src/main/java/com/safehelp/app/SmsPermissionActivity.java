...
public class SmsPermissionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SmsPermissionManager.isSmsPermissionGranted(this)) {
            SmsPermissionManager.requestSmsPermission(this);
        } else {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == SmsPermissionManager.REQUEST_CODE_SMS) {
            boolean granted = SmsPermissionManager.isSmsPermissionGranted(this);
    ...
    private void returnResultToReact(boolean granted) {
        ...
        String hashFragment = granted ? "sms_result=granted" : "sms_result=denied";
